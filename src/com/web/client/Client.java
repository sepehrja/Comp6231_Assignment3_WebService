...
//    public static final int SHUTDOWN = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        QName montrealQName = new QName("http://implementaion.service.web.com/", "EventManagement");
        montrealService = Service.create(montrealURL, montrealQName);

        URL quebecURL = new URL("http://localhost:8081/quebec?wsdl");
        QName quebecQName = new QName("http://implementaion.service.web.com/", "EventManagement");
        quebecService = Service.create(quebecURL, quebecQName);

        URL sherbrookURL = new URL("http://localhost:8082/sherbrook?wsdl");
        QName sherbrookQName = new QName("http://implementaion.service.web.com/", "EventManagement");
